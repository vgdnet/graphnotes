...
Плагин по умолчанию сам отправляет новые и изменённые файлы vault в личное хранилище (ТЗ 2.82: без выбора карточек). Общую ризому не трогает. `docs/OBSIDIAN_PLUGIN_API_TZ.md` — не канон: PLG-02/03 («сохранение не шлёт», обязательный выбор) сняты.
